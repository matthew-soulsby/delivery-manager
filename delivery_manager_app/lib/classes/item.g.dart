...
void _itemSerialize(
  ...
  writer.writeString(offsets[1], object.itemPLU);
  writer.writeString(offsets[2], object.name);
  writer.writeLong(offsets[3], object.priceCents);
}
...
Item _itemDeserialize(
  ...
  object.itemPLU = reader.readStringOrNull(offsets[1]);
  object.name = reader.readStringOrNull(offsets[2]);
  object.priceCents = reader.readLongOrNull(offsets[3]);
  return object;
}
...
extension ItemQueryFilter on QueryBuilder<Item, Item, QFilterCondition> {
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> itemPLUIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'itemPLU',
      ));
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> itemPLUIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'itemPLU',
      ));
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> itemPLUEqualTo(
    String? value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> itemPLUGreaterThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> itemPLULessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> itemPLUBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> itemPLUStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> itemPLUEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> itemPLUContains(String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'itemPLU',
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> itemPLUMatches(String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
        property: r'itemPLU',
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> itemPLUIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'itemPLU',
        value: '',
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> itemPLUIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'itemPLU',
        value: '',
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> priceCentsIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> priceCentsIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'priceCents',
      ));
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> priceCentsEqualTo(
      int? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'priceCents',
